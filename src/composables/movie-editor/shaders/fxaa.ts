...
/** FXAA 后处理着色器（基于 Three.js FXAAShader） */
export const FXAAShader = {
  ...
  fragmentShader: /* glsl */ `
    ...
    float _ContrastThreshold = 0.012;
    float _RelativeThreshold = 0.024;
    float _SubpixelBlending = 1.35;
    ...
    vec4 ApplyFXAA(sampler2D tex2D, vec2 texSize, vec2 uv) {
      ...
      if (ShouldSkipPixel(luminance)) return Sample(tex2D, uv);
